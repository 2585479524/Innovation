            ...
            <Row>
                ...
                <i-col span="7" push="17">
                    <Card dis-hover style="width:350px">
                        ...
                        <Card dis-hover style="width:315px">
                                <div>
                                    <span>未答题：<Icon type="ios-checkmark" v-model="tubiao"></Icon></span>
                                    <span>已答题：<i class="el-icon-circle-check"></i></span>
                                </div>
                            </Card>
                    </Card>
                </i-col>
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <el-radio-group v-model="itemDetail[itemNum-1].userChoose">
                                        <el-radio :label="item.options_id" :key="item.options_id" @change="choosed(item.options_id)"
