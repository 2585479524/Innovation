<template>
    <div id="app">
        <div class="newcon">
                        <font size="2">课程名称</font><font color="red" size="4">*</font>：<i-input type="text" class="form-control" style="width:200px" v-model="rowtemplate.Name" />
                        <br><br>
                        <font size="2">选择课程封面</font><font color="red" size="4">*</font>：
                        <el-upload
        ...
        <table cellspacing="0" class="table table-bordered table-striped text-center">
                ...
                <tbody>
                    <tr v-for="row in rows " :key="row.index" >
                            <td><router-link to="/teacher/coursevalue">
