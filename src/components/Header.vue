			...
			<div class="container container-navbar">
				...
				<div class="navbar-footer" aria-expanded="false"> 
					<ul class="nav">
						...
						<li><router-link to="/classpage">课程资源平台</router-link></li>
						<li><router-link to="#">创新创业平台</router-link></li>
						<li><router-link to="#">协同合作平台</router-link></li>
					</ul>
				</div>
			</div>
		</nav>
...
@media screen and (max-width: 768px) {/*界面小于768像素*/
